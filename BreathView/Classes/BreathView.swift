...
//  JiuYuan
//
//  Created by 汤天明 on 2019/3/26.
//  Copyright © 2019 汤天明. All rights reserved.
//

import UIKit

public class BreathView: UIView {
    ...
    lazy private var containerLayer:CAReplicatorLayer = {
        ...
        containerLayer.instanceColor = UIColor(red: 0.17, green: 0.59, blue: 0.60, alpha: 1.0).cgColor
    ...
    private func createPetal(center:CGPoint, radius:CGFloat) ->CAShapeLayer {
        ...
        let petalPath = UIBezierPath(arcCenter: center, radius: radius, startAngle: 0.0, endAngle: CGFloat(2.0 * CGFloat.pi), clockwise: true)
